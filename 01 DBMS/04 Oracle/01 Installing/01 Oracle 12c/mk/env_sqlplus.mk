...
ORATST=$(DBINHOME)oratst
SQLPLUS_SUIDLINKLDLIBS=$(LLIBCLNTSH) $(ORACLETTLIBS) $(SUIDLINKLDLIBS)
SQLPLUS_LINKLINE=$(LINK) -Wl,--no-as-needed $(SQLPLUSLIBS) $(LINKTTLIBS)
ISQLPLUS_LINKLINE=$(LINK) $(ISQLPLUSLIBS) $(LINKTTLIBS)

# Entering SRCHOME/sqlplus/s_sqlplus.mk

USRLIBS=-lpthread

DLOPENLIBS=$(LIBSQLPLUSSO) $(LIBISQLPLUSSO) $(LIBSQLPLUSICSO)
LIBS=$(LIBSQLPLUS) $(LIBISQLPLUS)

libsqlplusLIBS=$(LDPATHFLAG)$(PRODLIBHOME) $(LDPATHFLAG)$(LIBHOME) \
	$(SQLPLUS_SUIDLINKLDLIBS)

libisqlplusLIBS=$(LDPATHFLAG)$(PRODLIBHOME) $(LDPATHFLAG)$(LIBHOME) \
	$(LLIBSQLPLUS) $(SQLPLUS_SUIDLINKLDLIBS)

libsqlplusicLIBS=$(LDPATHFLAG)$(PRODLIBHOME) $(LDPATHFLAG)$(LIBHOME) \
	$(SQLPLUS_SUIDLINKLDLIBS)

# Exiting SRCHOME/sqlplus/s_sqlplus.mk
# Exiting sqlplus.mk
