...
# Entering SRCHOME/sdo/exports.mk
SDO_VERSION=12
SDODIRM=md
...
SDO_PGHOME=$(SDOHOME)property_graph
SDOSRC=$(SDOHOME)src/
...
WAR_EXT=war
ZIP_EXT=zip
WAR_IMAGESERVER=$(SDOJLIB)imageserver.$(WAR_EXT)
...
ZIP_NDM_TUTORIAL=$(SDOJLIB)ndm_tutorial.$(ZIP_EXT)
EAR_NDMSERVER=$(SDOJLIB)ndmserver.$(EAR_EXT)
ZIP_EAR_NDMSERVER=$(SDOJLIB)ndmserver.ear.$(ZIP_EXT)
...
JAR_SDOGCDRJ2EE=$(SDOJLIB)sdogcdrj2ee.$(JAR_EXT)
...
JAR_SDOGRX=$(SDOJLIB)georastertool.$(JAR_EXT)
...
JAR_SDONDMROUTER=$(SDOJLIB)sdondmrouter.$(JAR_EXT)
JAR_SDONDMAPPSDATA=$(SDOJLIB)sdondmappsdata.$(JAR_EXT)
JAR_SDONDME=$(SDOJLIB)sdondme.$(JAR_EXT)
JAR_SDONDMEXT=$(SDOJLIB)sdondmext.$(JAR_EXT)
JAR_SDONDMX=$(SDOJLIB)sdondmx.$(JAR_EXT)
JAR_SDONDMNFE=$(SDOJLIB)sdondmnfe.$(JAR_EXT)
...
JAR_SDODEP3PRT=$(SDOJLIB)sdodep3prt.$(JAR_EXT)
...
JAR_SDOOBJTRKR=$(SDOJLIB)sdoobjtrkr.$(JAR_EXT)
JAR_SDOCSWLOADER=$(SDOJLIB)sdocswloader.$(JAR_EXT)
# Entering SRCHOME/sdo/s_exports.mk
# Exiting SRCHOME/sdo/s_exports.mk
# Exiting SRCHOME/sdo/exports.mk
...
JDBC_VERSION_STRING = 12.2.0.1.0
...
JDBC_NEXT_JDK_DEBUG_JAR_NAME=ojdbc8_g.jar
JDBC_NEXT_JDK_DMS_JAR_NAME=ojdbc8dms.jar
JDBC_NEXT_JDK_DMS_DEBUG_JAR_NAME=ojdbc8dms_g.jar
...
# Entering SRCHOME/usm/exports.mk
...
# Exiting SRCHOME/usm/exports.mk
# Entering SRCHOME/oraolap/exports.mk
 # ORAOLAP exports.mk
...
# Entering SRCHOME/oraolap/s_exports.mk
S_OLAPPRELINKOPTS=
...
# Exiting SRCHOME/oraolap/s_exports.mk
# Entering SRCHOME/oraolap/sr_oraolap.mk
...
# Exiting SRCHOME/oraolap/sr_oraolap.mk
# Exiting SRCHOME/oraolap/exports.mk
# Entering SRCHOME/mgw/exports.mk

MGWHOME=$(ORACLE_HOME)/mgw/


# Exiting SRCHOME/mgw/exports.mk
# Entering SRCHOME/odbc/exports.mk
...
# Exiting SRCHOME/odbc/exports.mk
...
LIBVSNHPNAME=vsn_hp$(RDBMS_VERSION)
LIBVSNXPNAME=vsn_xp$(RDBMS_VERSION)
...
LIBS=$(LOC_LIBCOMMON) $(LOC_LIBGENERIC) $(LOC_LIBCLIENT) $(LOC_LIBSERVER) $(LOC_LIBPERFSRV) \
     ...
     $(LOC_LIBPATCHGENSH) $(LOC_LIBASMLG) $(LOC_LIBASMPERL) \
     $(LIBSKJCXD_STATIC) $(LOC_LIBRQEXT) $(LOC_LIBOFS) $(LOC_LIBORABASE)
SHLIBS=$(LIBODM) $(LIBNFSODM) $(LIBOFS) $(LIBASMCLNTSH) $(LIBORABASE)\
       $(S_SHLIBS)
NEW_LD_SHLIBS=$(LIBDBMIG) $(LIBORAMYSQL)
MAPLIBS=$(LIBMAPDUMMY) $(LIBMAPUFS) $(LIBMAPSYM) $(LIBMAPEXT)
DLOPENLIBS=$(LIBQSMASHR) $(LIBKUBSAGT) $(MAPLIBS) $(LIBFILESIZE) \
           $(LIBXDBSHR) $(LIBPATCHGENSH) $(LIBASMLG) \
           $(S_DLOPENLIBS) $(LIBDBGUISS) $(LIBASMPERL) $(LIBRQEXT)
...
HSALIB_SUBSET2=$(LLIBAGTSH) $(LLIBTHREAD) $(LLIBCLNTSH) \
	$(HSA_OSDLINK_APPEND) $(LLIBNSGR) $(LINKLDLIBS) 
...
CLOUD_ON=kscson.$(OBJ_EXT)
CLOUD_OFF=kscsof.$(OBJ_EXT)
...
ORABASECONFIGMAI = $(RDBMSLIB)orabaseconfig.$(OBJ_EXT)
ORABASEHOMEMAI = $(RDBMSLIB)orabasehome.$(OBJ_EXT)
ORAHOMEMAI = $(RDBMSLIB)orahome.$(OBJ_EXT)
ORADISMMAI = $(RDBMSLIB)soradism.$(OBJ_EXT)
MKPATCHMAI = $(RDBMSLIB)mkpatch.$(OBJ_EXT)
OPUTILMAI = $(RDBMSLIB)s0ksptchutl.$(OBJ_EXT)
...
DNFSTESTMAI = $(RDBMSLIB)dnfstest.$(OBJ_EXT)
DNFSTEST_UTMAI = $(RDBMSLIB)dnfstest_ut.$(OBJ_EXT)
DNFSTEST_THRDSMAI = $(RDBMSLIB)dnfstest_thrds.$(OBJ_EXT)
ORADNFSAUX = 
...
JSSUTRC1 = $(RDBMSLIB)sjssutrace.$(OBJ_EXT)
JSSUTRC2 = $(RDBMSLIB)jssutrace.$(OBJ_EXT)
...
ZDLRA = $(RDBMSLIB)kbrsopt.$(OBJ_EXT)
...
ORABASECONFIG=$(RDBMSBIN)orabaseconfig$(EXE_SUFFIX)
ORABASEHOME=$(RDBMSBIN)orabasehome$(EXE_SUFFIX)
ORAHOME=$(RDBMSADMIN)orahome$(EXE_SUFFIX)
ORADISM=$(RDBMSBIN)oradism$(EXE_SUFFIX)
MKPATCH=$(RDBMSBIN)mkpatch$(EXE_SUFFIX)
OPUTIL=$(RDBMSBIN)oputil$(EXE_SUFFIX)
...
DNFSTEST=$(RDBMSBIN)dnfstest$(EXE_SUFFIX)
DNFSTEST_UT=$(RDBMSBIN)dnfstest_ut$(EXE_SUFFIX)
DNFSTEST_THRDS=$(RDBMSBIN)dnfstest_thrds$(EXE_SUFFIX)
...
RAMAI=$(RDBMSLIB)$(LIBRANAME)ic.$(OBJ_EXT)
RASRC=$(RDBMSLIB)$(LIBRANAME)ic.c
RALOG=$(RDBMSLIB)$(LIBRANAME)ic.log
RAPA_OBJ=$(RDBMSLIB)kbhspars.$(OBJ_EXT)
RAHT_OBJ=$(RDBMSLIB)kbhshtrs.$(OBJ_EXT)
RAXM_OBJ=$(RDBMSLIB)kbhsxmrs.$(OBJ_EXT)
FORCE_RAIC=force_raic
...
ORION_LINKLINE=$(LINK) $(OPT) -Wl,--no-as-needed $(ORIONMAI) $(LLIBORION) $(LLIBCLNTSH) \
        $(CSSCLNTLIBS_SERVER) $(LLIBASMCLNT) $(LLIBGENERIC) $(LLIBCORE) \
        $(LLIBNZ) $(LLIBNFSODM) $(LLIBSAGE) $(LLIBSKGXP) \
        $(LLIBNLSRTL) $(PL_AIOLIB) $(LLIBCOMMON) $(LINKLDLIBS)
ASMLG_LINKLINE=$(LINK) $(OPT) $(ASMLGMAI) $(LLIBASMLG) \
               $(LLIBCLNTSH) $(LLIBASMCLNTSH) $(NZLIBS) $(CSSCLNTLIBS_SERVER) \
               $(LLIBASMCLNT) $(LLIBGENERIC) $(LLIBCORE) \
               $(LLIBSAGE) $(LLIBSKGXP) \
...
SYSRESVER_LINKLINE=$(LINK) $(OPT) $(SYSRESVMAI) $(SSDBED) \
	$(LINKTTLIBS)
ORABASEHOME_LINKLINE=$(LINK) $(ORABASEHOMEMAI) $(LLIBCLNTST) $(LINKLDLIBS)
ORAHOME_LINKLINE=$(LINK) $(ORAHOMEMAI) $(LLIBCLNTST) $(LINKLDLIBS)
ORABASECONFIG_LINKLINE=$(LINK) $(ORABASECONFIGMAI) $(LLIBCLNTST) $(LINKLDLIBS)
ORADISM_LINKLINE=$(LINK) $(ORADISMMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
MKPATCH_LINKLINE=$(LINK) $(MKPATCHMAI) $(LINKTTLIBS)
OPUTIL_LINKLINE=$(LINK) $(OPT) $(OPUTILMAI) $(LLIBDBTOOLS) $(LINKTTLIBS)
ODUMPOBJ_LINKLINE=$(LINK) $(OPT) $(ODUMPOBJMAI) $(LINKTTLIBS)
ORADNFS_LINKLINE=$(LINK) $(ORADNFSMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
DNFSTEST_LINKLINE=$(LINK) $(DNFSTESTMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
DNFSTEST_UT_LINKLINE=$(LINK) $(DNFSTEST_UTMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
DNFSTEST_THRDS_LINKLINE=$(LINK) $(DNFSTEST_THRDSMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
CCODELIB_LINKLINE=$(LINK) $(CCODELIBMAI) $(LINKTTLIBS)
...
MAPSGA_LINKLINE=$(LINK) $(OPT) $(MAPSGAMAI) $(SSDBED) $(KSMS) \
	$(LINKTTLIBS) 
ORAPWD_LINKLINE=$(LINK) $(OPT) -Wl,--no-as-needed $(PWDMAI) $(PWDCLSR) $(SSDBED) $(ASMCLNTSH_LIBS) $(HAS_SKGXNLIBS) $(LLIBHASGEN) $(LLIBOCR) $(CLSRLIBS_SERVER) $(LLIBOCRBACKEND) $(LLIBOCRUTL) $(LINKTTLIBS)
TKPROF_LINKLINE=$(LINK) $(OPT) -Wl,--no-as-needed $(TKPMAI) $(SSDBED) $(LINKTTLIBS)
PLSHPROF_LINKLINE=$(LINK) $(OPT) -Wl,--no-as-needed $(PLSTMAI) $(LLIBCLNTSH) \
	$(LLIBCLIENT) $(LIBGENERIC) $(LINKLDLIBS)
...
TG4PWD_LINKLINE= $(LINK) $(OPT) -Wl,--no-as-needed $(TG4PWDMAI) \
...
KFED_LINKLINE=$(LINK) $(S0MAIN) -Wl,--no-as-needed $(SSKFEDED) $(SKFEDPT) $(LLIBDBTOOLS) \
              $(LLIBASMCLNTSH) $(LLIBCLNTSH) $(NZLIBS) $(LLIBSAGE) \
              $(LLIBSKGXP) $(CSSCLNTLIBS_SERVER) $(LLIBASMCLNT) $(LINKTTLIBS)

KFOD_LINKLINE=$(LINK) $(S0MAIN) -Wl,--no-as-needed $(SSKFODED) $(SKFODPT) $(KFODOBJ) \
	$(LLIBASMCLNTSH) $(LLIBCLNTSH) $(LLIBDBTOOLS) \
...
JSSU_LINKLINE=$(LINK) $(OPT) $(JSSUMAI) $(JSSUMAI2) $(JSSU_OSLIBS) \
               $(JSSUTRC1) $(JSSUTRC2) $(LINKLDLIBS_4_JSSU)
LINKLDLIBS_4_JSSU= $(LIBGENERIC) $(LIBCOMMON) $(CORELIBS) $(SUIDLINKLDLIBS)

GENEZI_LINKLINE=$(LINK) $(GENEZIMAI) $(LLIBCLNTSH) $(SUIDLINKLDLIBS)

WRC_LINKLINE=$(LINK) $(OPT) $(S0MAIN) $(SSKECED) $(SKECPT) $(LLIBWRC) \
             $(LLIBTHREAD) $(LINKTTLIBS)
...
BUILD_LIBOCIEI_BASIC_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(CP) genezi$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        ...
        echo "" >> $(LIBOCIEI_SHIP_BASE)/BASIC_README; \
        $(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/BASIC_README; \
	$(CD) $(ORACLE_HOME)/bin; \
...
BUILD_LIBOCIEI_BASIC_LITE_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(CP) genezi$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        ...
        echo "" >> $(LIBOCIEI_SHIP_BASE)/BASIC_LITE_README; \
        $(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/BASIC_LITE_README; \
	$(CD) $(ORACLE_HOME)/bin; \
	$(CP) adrci$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        $(CP) uidrvci$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CD) $(ORACLE_HOME)/$(LIBDIR); \
...
BUILD_LIBOCIEI_JDBC_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(BUILD_LIBOCIEI_JDBC_EXTRA_ZIP); \
        ...
        echo "" >> $(LIBOCIEI_SHIP_BASE)/JDBC_README; \
        $(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/JDBC_README; \
...
BUILD_LIBOCIEI_TOOLS_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(MKDIRP) $(LIBOCIEI_SHIP_BASE); \
	$(CD) $(ORACLE_HOME)/$(LIBDIR); \
	$(CP) $(LIB_PREFIX)nfsodm$(RDBMS_VERSION).$(SO_EXT) $(LIBOCIEI_SHIP_BASE); \
	$(CD) $(ORACLE_HOME)/bin; \
	$(CP) wrc$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CP) sqlldr$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CP) exp$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CP) imp$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CP) impdp$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CP) expdp$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
	$(CD) $(LIBOCIEI_BASE); \
        ...
        echo "" >> $(LIBOCIEI_SHIP_BASE)/TOOLS_README; \
        $(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/TOOLS_README; \
...
BUILD_LIBOCIEI_SQLPLUS_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(CP) glogin.sql $(LIBOCIEI_SHIP_BASE); \
        ...
        echo "" >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        $(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
	$(CD) $(LIBOCIEI_BASE); \
...
BUILD_LIBOCIEI_ODBC_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(CP) ODBC_IC_Readme_Unix.html $(LIBOCIEI_SHIP_BASE); \
        ...
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/ja; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/ja/META-INF; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img/odbcdrvarch.gif $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img/setup_app.gif $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img/setup_ssmig.gif $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img/odbcmodel.gif $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img/setup_ora.gif $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img/setup_work.gif $(LIBOCIEI_SHIP_BASE)/help/ja/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img_text/odbcdrvarch.htm $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img_text/setup_app.htm $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img_text/setup_ssmig.htm $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img_text/odbcmodel.htm $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img_text/setup_ora.htm $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/img_text/setup_work.htm $(LIBOCIEI_SHIP_BASE)/help/ja/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/META-INF/MANIFEST.MF $(LIBOCIEI_SHIP_BASE)/help/ja/META-INF; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/blafdoc.css $(LIBOCIEI_SHIP_BASE)/help/ja/; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/map.xml $(LIBOCIEI_SHIP_BASE)/help/ja/; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/oracle.gif $(LIBOCIEI_SHIP_BASE)/help/ja/; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/toc.htm $(LIBOCIEI_SHIP_BASE)/help/ja/; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/cpyr.htm $(LIBOCIEI_SHIP_BASE)/help/ja/; \
        $(CP) $(ORACLE_HOME)/odbc/help/ja/sqora.htm $(LIBOCIEI_SHIP_BASE)/help/ja/; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/us; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(MKDIR) $(LIBOCIEI_SHIP_BASE)/help/us/META-INF; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img/odbcdrvarch.gif $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img/setup_app.gif $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img/setup_ssmig.gif $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img/odbcmodel.gif $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img/setup_ora.gif $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img/setup_work.gif $(LIBOCIEI_SHIP_BASE)/help/us/img; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img_text/odbcdrvarch.htm $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img_text/setup_app.htm $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img_text/setup_ssmig.htm $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img_text/odbcmodel.htm $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img_text/setup_ora.htm $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/img_text/setup_work.htm $(LIBOCIEI_SHIP_BASE)/help/us/img_text; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/META-INF/MANIFEST.MF $(LIBOCIEI_SHIP_BASE)/help/us/META-INF; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/blafdoc.css $(LIBOCIEI_SHIP_BASE)/help/us/; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/map.xml $(LIBOCIEI_SHIP_BASE)/help/us/; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/oracle.gif $(LIBOCIEI_SHIP_BASE)/help/us/; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/toc.htm $(LIBOCIEI_SHIP_BASE)/help/us/; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/cpyr.htm $(LIBOCIEI_SHIP_BASE)/help/us/; \
        $(CP) $(ORACLE_HOME)/odbc/help/us/sqora.htm $(LIBOCIEI_SHIP_BASE)/help/us/; \
	$(CD) $(LIBOCIEI_BASE); \
...
LIBRASO_POPULATE=$(CD) $(ORACLE_HOME); \
	$(EXEC_GENEZI) -s $(LIBRASO) "$(GENEZI_OSBWS_DIRS)" "$(GENEZI_OSBWS_PATS)" "osbwsic" > $(RALOG);\
...
LLIBOFS=$(LDLIBFLAG)$(ILIB_PREFIX)ofs$(ILIB_SUFFIX)
LIBOFS=$(LIBHOME)$(LIB_PREFIX)ofs.$(DEPSO_EXT)
LIBOFSD=$(LIBHOME)$(LIB_PREFIX)ofsd.$(DEPSO_EXT)
LOC_LIBOFS=$(RDBMSLIB)$(LIB_PREFIX)ofs.$(LIB_EXT)

LIBDMEXTNAME=dmext
LLIBDMEXT=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBDMEXTNAME)$(ILIB_SUFFIX)
LOC_LIBDMEXT=$(RDBMSLIB)$(LIB_PREFIX)$(LIBDMEXTNAME).$(LIB_EXT)
...
LLIBORABASE=$(LDLIBFLAG)$(ILIB_PREFIX)orabase$(RDBMS_VERSION)$(ILIB_SUFFIX)
LIBORABASE=$(LIBHOME)$(LIB_PREFIX)orabase$(RDBMS_VERSION).$(DEPSO_EXT)
LOC_LIBORABASE=$(RDBMSLIB)$(LIB_PREFIX)orabase$(RDBMS_VERSION).$(LIB_EXT)

LIBSYSRNAME=R
LLIBSYSR=$(LDLIBFLAG)$(LIBSYSRNAME)
LIBRQEXTNAME=rqext
LIBRQEXT=$(RDBMSLIB)$(LIB_PREFIX)$(LIBRQEXTNAME).$(SO_EXT)
...
INSTALL_TARGS=clean idbv itstshm imaxmem iorapwd idbfsize idumpsga\
	...
	ikgmgr iloadpsp idgmgrl $(IHSO) inid iextjobo iextjob ijssu ikfod\
        ...
        irenamedg install_srvm isetasmgid iorion iskgxpinfo itrcldr \
        ioputil
...
ITEST=ioracle idbv itstshm imaxmem iorapwd idbfsize icursize \
	...
	idrdactl idrdalsnr idrdaproc ioputil
...
ALL_EXECS=oracle dbv tstshm maxmem orapwd dbfsize cursize \
      ...
      osh sbttest expdp impdp imp exp sqlldr rman \
      $(S_HSODBC) mkpatch oputil \
      $(S_TG4DB2) $(S_TG4IFMX) $(S_TG4MSQL) $(S_TG4SYBS) $(S_TG4TERA) \
...
LIBOSBWSNAME=osbws
LIBOSBWSSONAME=$(LIBOSBWSNAME)
LIBOSBWSSO=$(LIBHOME)$(LIB_PREFIX)$(LIBOSBWSSONAME).$(SO_EXT)
LOC_LIBOSBWS=$(RDBMSLIB)$(LIB_PREFIX)$(LIBOSBWSNAME)$(RDBMS_VERSION).$(LIB_EXT)

LIBRANAME=ra
LIBRASONAME=$(LIBRANAME)
LIBRASO=$(LIBHOME)$(LIB_PREFIX)$(LIBRASONAME).$(SO_EXT)

LIBOPCNAME=opc
LIBOPCSONAME=$(LIBOPCNAME)
LIBOPCSO=$(LIBHOME)$(LIB_PREFIX)$(LIBOPCSONAME).$(SO_EXT)

LOC_LIBORAMYSQL=$(RDBMSLIB)$(LIB_PREFIX)$(LIBORAMYSQLNAME).$(LIB_EXT)


LOC_LIBFTHREAD=$(RDBMSLIB)$(LIB_PREFIX)$(LIBFTHREADNAME).$(LIB_EXT)

DBLEXT=dbl
LIBVSNCSENAMESHIP=vsn$(RDBMS_VERSION)_cse
LIBVSNCSE=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNCSENAMESHIP).$(DEPLIB_EXT).$(DBLEXT)
LIBVSNCEENAMESHIP=vsn$(RDBMS_VERSION)_cee
LIBVSNCEE=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNCEENAMESHIP).$(DEPLIB_EXT).$(DBLEXT)
LIBVSNSENAMESHIP=vsn$(RDBMS_VERSION)_std
LIBVSNSE=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNSENAMESHIP).$(DEPLIB_EXT).$(DBLEXT)
LIBVSNEENAMESHIP=vsn$(RDBMS_VERSION)_ee
LIBVSNEE=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNEENAMESHIP).$(DEPLIB_EXT).$(DBLEXT)
LIBVSNHPNAMESHIP=vsn$(RDBMS_VERSION)_hp
LIBVSNHP=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNHPNAMESHIP).$(DEPLIB_EXT).$(DBLEXT)
LIBVSNXPNAMESHIP=vsn$(RDBMS_VERSION)_xp
LIBVSNXP=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNXPNAMESHIP).$(DEPLIB_EXT).$(DBLEXT)
LIBVSNBACKUPNAMESHIP=vsn$(RDBMS_VERSION)_backup
LIBVSNBACKUP=$(LIBHOME)$(LIB_PREFIX)$(LIBVSNBACKUPNAMESHIP).$(DEPLIB_EXT).$(DBLEXT)


# Entering SRCHOME/rdbms/s_rdbms.mk
...
POST_LINK_TASKS=(\
	$(RMF) $(RDBMSUTL)do-dep.out ;\
	$(PERL) $(RDBMSUTL)create_do_dep.pl -product SERVER -copy ;\
	)

ifeq ($(COVERAGE_RUN),1)
  COVERAGE_JAVA_SETUP=$(PERL) $(RDBMSUTL)coverage_java_setup.pl
endif
...
PERLVERSION=$(shell $(ORACLE_HOME)/perl/bin/perl -se 'printf "%vd", $$^V')
PERLCOREDIR=$(ORACLE_HOME)/perl/lib/$(PERLVERSION)/x86_64-linux-thread-multi/CORE
...
$(LIB_PREFIX)skgxpg.ohso\
$(LIB_PREFIX)skgxpr.ohso
...
LPTEXTON=lptext_on
LPTEXTOFF=lptext_off

LPTEXTOBJ=$(RDBMSLIB)shugetlbfs.$(OBJ_EXT)

LPTEXTEDIT=/usr/bin/hugeedit
LPTEXTSHLIB=/usr/lib64/libhugetlbfs.so

LPTEXTSUPPORTED=test -x $(LPTEXTEDIT) -a -r $(LPTEXTSHLIB)

LPTEXTLDFLAGS=-Wl,-zcommon-page-size=2097152 -Wl,-zmax-page-size=2097152 -lhugetlbfs

ORACLE_LPTEXT=`$(LPTEXTSUPPORTED) && test -r $(LPTEXTOBJ) && echo $(LPTEXTLDFLAGS)`
ORACLE_LINKLINE+=$(ORACLE_LPTEXT)

$(LPTEXTOFF): $(ALWAYS)
	$(SILENT)$(RMF) $(LPTEXTOBJ)
	$(SILENT)$(ECHO) Oracle binary will use regular pages for text

$(LPTEXTON): $(ALWAYS)
	$(SILENT)$(RMF) $(LPTEXTOBJ)
	$(SILENT)$(LPTEXTSUPPORTED) && \
          ($(TOUCH) $(LPTEXTOBJ) ; $(ECHO) Oracle binary will use large pages for text) || \
          ($(ECHO) libhugetlbfs RPMs are not present on this system; /bin/false)
...
LIBRASO_LINKLINE=$(LINK) -shared -Bsymbolic -Wl,--version-script=$(RDBMSADMIN)$(LIBOSBWSNAME).$(DEF_EXT) $(RAMAI) $(SOSBWS_OBJ) $(RAPA_OBJ) $(RAHT_OBJ) $(RAXM_OBJ) -Wl,--whole-archive $(LOC_LIBOSBWS) -Wl,--no-whole-archive -l$(LIBGENERICNAME) $(LLIBCLNTST) $(SUIDLINKLDLIBS)
...
ifneq ($(strip $(JDBC_NEXT_JDK_OPT_JAR_NAME)), )
DEFINE_NEXT_JAR_OPT=--define "jdbc_next_jar $(JDBC_NEXT_JDK_OPT_JAR_NAME)"
endif

RPM_DEFINES = --define "_sourcedir $(LIBOCIEI_BASE)" --define "_builddir $(RPM_DIR)/BUILD" --define "_srcrpmdir $(RPM_DIR)/SRPMS" --define "_rpmdir $(RPM_DIR)/RPMS" --define "_tmppath $(RPM_DIR)/tmp" --define "install_dir $(RPM_INSTALL_DIR)" --define "default_version $(CLIENT_RPM_VERSION)" --define "rdbms_major $(RDBMS_VERSION)" --define "rdbms_minor_version $(MINORVSN)" --define "client_lib_minor_version $(CLIENT_LIB_MINOR_VERSION)" --define "jdbc_current_jar $(JDBC_CURRENT_JDK_OPT_JAR_NAME)" $(DEFINE_NEXT_JAR_OPT) --define "sqlplus_exe $(RPM_SQLPLUS_EXE)" --define "debug_package %{nil}" --define "_enable_debug_package 0"
...
LIBSHPKSSE42=$(LIBHOME)$(LIB_PREFIX)$(LIBSHPKSSE42NAME).$(DEPSO_EXT)
...
LIBSHPKAVX=$(LIBHOME)$(LIB_PREFIX)$(LIBSHPKAVXNAME).$(DEPSO_EXT)
...
LIBSHPKAVX2=$(LIBHOME)$(LIB_PREFIX)$(LIBSHPKAVX2NAME).$(DEPSO_EXT)
...
LIBSHPKAVX512NAME=shpkavx512$(RDBMS_VERSION)
LIBSHPKAVX512=$(LIBHOME)$(LIB_PREFIX)$(LIBSHPKAVX512NAME).$(DEPSO_EXT)
LLIBSHPKAVX512=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBSHPKAVX512NAME)$(ILIB_SUFFIX)
LIBSHPKAVX512_CFILES=kdzk_avx512.c
libshpkavx512$(RDBMS_VERSION)LIBS=-Wl,-Bsymbolic

LIBSHPK=$(LIBSHPKSSE42) $(LIBSHPKAVX) $(LIBSHPKAVX2) $(LIBSHPKAVX512)

LIBSHPK_OHSO=$(LIB_PREFIX)shpksse42$(RDBMS_VERSION).ohso\
$(LIB_PREFIX)shpkavx$(RDBMS_VERSION).ohso\
$(LIB_PREFIX)shpkavx2$(RDBMS_VERSION).ohso\
$(LIB_PREFIX)shpkavx512$(RDBMS_VERSION).ohso

S_OHSO_TARGETS=$(LIB_PREFIX)skvol$(RDBMS_VERSION).ohso\
$(LIBSKGXP_OHSO)\
$(LIBSKGXN_OHSO)\
$(LIBSHPK_OHSO)
...
$(LIB_PREFIX)$(LIBRQEXTNAME)LIBS=$(LLIBSYSR) $(LLIBCLNTSH)
LOC_LIBRQEXT=$(RDBMSLIB)$(LIB_PREFIX)$(LIBRQEXTNAME).$(LIB_EXT)

MAKE_LIBRQEXT=$(MAKE) $(LIBRQEXT)
...
ORATOPOBJ=$(RDBMSLIB)oratop.$(OBJ_EXT)
ORATOP=$(RDBMSBIN)oratop$(EXESUFFIX)
ORATOP_LINKLINE=$(LINK) $(ORATOPOBJ) $(LLIBCLNTSH) $(USRLIBS) $(COMPEOBJS) $(SYSLIBS)

ifeq ($(PLATFORM), x86_64)
  LIBGCC_LOC=$(dir $(shell /usr/bin/gcc -m64 -print-libgcc-file-name))
  LIBGCC_LOC32=$(dir $(shell /usr/bin/gcc -m32 -print-libgcc-file-name))

  BUILDLIB_NO_CONTEXT += -L$(LIBGCC_LOC)
  BUILDLIB32_NO_CONTEXT += -L$(LIBGCC_LOC32)
  BUILDLIB_WITH_CONTEXT += -L$(LIBGCC_LOC)
  BUILDLIB32_WITH_CONTEXT += -L$(LIBGCC_LOC32)
  BUILD_USERCALLBACK += -L$(LIBGCC_LOC)
  BUILD_USERCALLBACK32 += -L$(LIBGCC_LOC32)
endif


# Exiting SRCHOME/rdbms/s_rdbms.mk
# Exiting rdbms.mk
